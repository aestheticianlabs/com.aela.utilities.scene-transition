...
- Prevent ArgumentException if previous scene is unloaded during scene transition. Log error instead.
...
- Only unload previously active scene if it is the scene we expect it to be
